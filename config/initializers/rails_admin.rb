# RailsAdmin config file. Generated on December 22, 2011 18:06
...
RailsAdmin.config do |config|
  ...
  config.main_app_name = ['Dvhk', 'Admin']
  ...
  #     configure :active_shift, :integer 
  #     configure :is_domestic, :boolean 
  #     configure :is_departure, :boolean 
  #     configure :active_date, :datetime 
  #     configure :is_completed, :boolean   #   # Sections:
  #   list do; end
  #   export do; end
  #   show do; end
  #   edit do; end
  ...
  #     configure :routing, :belongs_to_association 
  #     configure :priority, :belongs_to_association 
  #     configure :user, :belongs_to_association   #   # Found columns:
  #     configure :id, :integer 
  #     configure :pax_name, :string 
  #     configure :personal_id, :string 
  #     configure :routing_id, :integer         # Hidden 
  #     configure :remark, :text 
  #     configure :ticket_class, :string 
  #     configure :priority_id, :integer         # Hidden 
  #     configure :sequence, :integer 
  #     configure :origin_flt, :string 
  #     configure :accepted_flt, :string 
  #     configure :accepted, :boolean 
  #     configure :called, :boolean 
  ...
  #     configure :pri_level, :integer 
  #     configure :pri_name, :string 
  #     configure :created_at, :datetime 
  #     configure :updated_at, :datetime 
  #     configure :is_active, :boolean 
  #     configure :expired_date, :datetime   #   # Sections:
  #   list do; end
  #   export do; end
  #   show do; end
  #   edit do; end
  ...
  #   update do; end
  # end
  # config.model Routing do
  #   # Found associations:
  #     configure :passengers, :has_many_association   #   # Found columns:
  #     configure :id, :integer 
  #     configure :routing, :string 
  #     configure :destination, :string 
  #     configure :is_domestic, :boolean 
  #     configure :include_transit, :boolean 
  #     configure :transit_point, :string 
  #     configure :created_at, :datetime 
  #     configure :updated_at, :datetime   #   # Sections:
  #   list do; end
  #   export do; end
  ...
  #   # Found associations:
  #     configure :passengers, :has_many_association 
  #     configure :briefingposts, :has_many_association 
  #     configure :associated_audits, :has_many_association         # Hidden   #   # Found columns:
  #     configure :id, :integer 
